...
| `final-validation-9d7a3b9.raw.b64` | `7b62431d2f0a8e20cc5a9c72abcc72e1ceb49adca430f581a38748d71170ff7e` | `bash -c 'PYTHON=/mnt/c/Users/nrsan/.codex/worktrees/aura-m0-m1/Aura/.venv/Scripts/python.exe ./scripts/validate.sh'`; exit 1. Tests gate lacked `PYTHONPATH=src`; slice gate reported stale candidate tree (recorded `1d072c...`, current `8ed749...`) after completion-note edits. |
